...
import TopSearches from '@/components/molecules/top-searches/TopSearches'
import Textarea from '@/components/atoms/textarea/Textarea'
import AdvertisementCard from '@/components/molecules/cards/advertisement-card/AdvertisementCard'
		...
		<>
			{messages.length === 0 ? (
				<section className={style.wrapperMain}>
					...
					<div className={style.wrapperMainSearches}>
						<TopSearches onSearchClick={handleTextSubmit} />
					</div>
				...
				<div className={style.wrapperSearch}>
					<div className={style.wrapperSearchContent}>
						...
						<div className={style.wrapperSearchContentAds}>
							<AdvertisementCard />
						</div>
					</div>
