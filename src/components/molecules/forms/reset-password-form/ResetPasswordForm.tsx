    ...
    >
      <div className={style.formGroup}>
        <div className={style.formContent}>
          <Heading as="h4" fontWeight="bold">Create A Strong Password</Heading>
          <P as="p" extraClass={style.intructions}>Your password must contain at least 6 characters, including a combination of letters, numbers, and special characters (such as !$@%).</P>
